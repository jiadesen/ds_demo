...
checkLogined(); //检查是否登录，未登录则调用该方法阻止进入管理员页面，而跳转到用户登录界面
?>
<!doctype html>
<html>
<head>
...
<div class="operation_user clearfix">
  ...
  <div class="link fr">
    <b>欢迎您
      ...
      } elseif (isset($_COOKIE['adminName'])) { //如果cookie中设置了值
        echo $_COOKIE['adminName'];
      }
      ?>
    </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="doAdminAction.php?act=homepage" class="icon icon_i">首页</a><span></span><a
      href="#"
      class="icon icon_j">前进</a><span></span><a
      href="#" class="icon icon_t">后退</a><span></span><a onclick="document.location.reload();" class="icon icon_n">刷新</a><span></span><a
